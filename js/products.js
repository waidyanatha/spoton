...
//    var imgURL = "<p><image src='" + data.products[x].imgURL + "' height='220' width='260'></image></p>";

    var subProds = "<ul>";
    for (var i in data.products[x].subProd) 
    {
        subProds += "<li><a href='javascript:void(0);' onclick='show_sub_prod(" + x + "," + i + ");' ><p>" + data.products[x].subProd[i].desc + "</p></a></li><br>";
    }
    subProds += "</ul>";

    document.getElementById("summtitle").innerHTML=summtitle;
    document.getElementById("submenudesc").innerHTML=submenudesc;
    document.getElementById("demo").innerHTML=demo;
//    document.getElementById("imgTitle").innerHTML=imgTitle;
//    document.getElementById("imgURL").innerHTML=imgURL;
    document.getElementById("subProds").innerHTML=subProds;
};

function show_sub_prod(x,y){
    var solImg = "<img src='" + data.products[x].subProd[y].prodURL + "' />";    
    document.getElementById("solImg").innerHTML=solImg;
};
